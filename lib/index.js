...
function contrastColor ( {
	...
	] = [ bgColor, fgDarkColor, fgLightColor, defaultColor ].map( ( p ) => namedColors[ p ] );
	...
	const darkOrLight = yiq >= threshold
...
module.exports.namedColors = NAMED_COLORS;